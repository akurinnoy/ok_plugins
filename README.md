...
| [ok-prerelease-verification](./plugins/ok-prerelease-verification) | PR readiness assessment (any repo) + DWO prerelease verification |
| [ok-council](./plugins/ok-council) | 3-model LLM Council: Claude Opus, Gemini 3 Pro, GPT-5.3 Codex. Requires [Gemini CLI](https://github.com/google-gemini/gemini-cli) and [Cursor Agent CLI](https://cursor.com/docs/cli/installation) |
